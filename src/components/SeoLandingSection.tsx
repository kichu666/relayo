    ...
    <section className="w-full max-w-6xl mx-auto mt-16 pt-12 border-t border-white/10 [html[data-theme=light]_&]:border-[#D7E8FF] space-y-16 px-4 sm:px-6">
      ...
      <div className="glass-panel p-6 sm:p-8 rounded-3xl border border-white/10 [html[data-theme=light]_&]:border-[#D7E8FF] bg-slate-900/60 [html[data-theme=light]_&]:bg-white backdrop-blur-xl shadow-xl [html[data-theme=light]_&]:shadow-sm space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2">
          <div className="flex items-start gap-3 p-4 rounded-2xl bg-black/40 [html[data-theme=light]_&]:bg-[#F8FCFF] border border-white/10 [html[data-theme=light]_&]:border-[#D7E8FF]">
        ...
        <div className="space-y-3 max-w-4xl mx-auto">
          {faqs.map((faq, idx) => {
            ...
            return (
              <div
                key={idx}
                className="glass-panel rounded-2xl border border-white/10 [html[data-theme=light]_&]:border-[#D7E8FF] bg-slate-900/40 [html[data-theme=light]_&]:bg-white overflow-hidden transition-all duration-200"
              >
                <button
                  onClick={() => toggleFaq(idx)}
                  className="w-full flex items-center justify-between p-4 sm:p-5 text-left cursor-pointer focus:outline-none"
                >
                  <span className="text-sm font-extrabold text-white [html[data-theme=light]_&]:text-[#0F172A] pr-4">
                    {faq.question}
                  </span>
                  {isOpen ? (
                    <ChevronUp className="w-4 h-4 text-cyan-400 [html[data-theme=light]_&]:text-cyan-600 shrink-0" />
                  ) : (
                    <ChevronDown className="w-4 h-4 text-slate-400 [html[data-theme=light]_&]:text-slate-500 shrink-0" />
                  )}
                </button>
