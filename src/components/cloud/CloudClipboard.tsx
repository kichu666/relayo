      ...
      <div className="glass-panel p-6 rounded-2xl border border-white/10 [html[data-theme=light]_&]:border-[#E5E5EA] bg-slate-900/60 [html[data-theme=light]_&]:bg-white [html[data-theme=light]_&]:shadow-[0_4px_24px_rgba(0,0,0,0.04)] backdrop-blur-xl shadow-lg">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-4">
          <div className="flex items-center gap-2">
            <ClipboardCopy className="w-5 h-5 text-cyan-400 [html[data-theme=light]_&]:text-[#007AFF]" strokeWidth={2} />
          ...
          >
            <ClipboardPaste className="w-4 h-4 text-cyan-400 [html[data-theme=light]_&]:text-[#007AFF]" strokeWidth={2} />
        ...
        <div className="flex items-center justify-between mt-4">
          <span className="text-xs font-medium text-slate-400 [html[data-theme=light]_&]:text-[#86868B]">
